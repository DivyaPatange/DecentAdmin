...
class AdmissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('parents.admission.index', compact('admission'));
    }
    ...
    public function create()
    {
        ...
        return view('parents.admission.create', compact('academicYear', 'class', 'class1', 'class2', 'class3'));
    }
    ...
    public function storeJuniorAdmission(Request $request)
    {
        ...
        $admission->created_by = "Parent";
        $admission->parent_id = Auth::guard('parent')->user()->id;
        ...
        return redirect('/parent/admission')->with('success', 'Admission Created Successfully!');
    }
    ...
    public function show($id)
    {
        ...
        {
            return view('parents.admission.showJr', compact('admission'));
        }
        else{
            return view('parents.admission.showPri', compact('admission'));
        }
    }
    ...
    public function edit($id)
    {
        ...
        if($admission->admission_for == "Junior College Admission")
        {
            return view('parents.admission.editJr', compact('admission', 'class1', 'class2', 'academicYear'));
        }
        else{
            return view('parents.admission.editPri', compact('admission', 'academicYear', 'class', 'class3'));
        }
    }
    ...
    public function updateJuniorAdmission(Request $request, $id)
    {
        ...
        return redirect('/parent/admission')->with('success', 'Admission Updated Successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        $admission->delete();
        return redirect('/parent/admission')->with('success', 'Admission Deleted Successfully!');
    }
}

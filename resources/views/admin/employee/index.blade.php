    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5>Employee List</h5>
                <a href="{{ route('admin.employee.create') }}"><button class="btn waves-effect waves-light btn-primary btn-sm float-right"><i class="icofont icofont-user-alt-3"></i>Add New</button></a>
            </div>
...
<script>
var SITEURL = '{{ route('admin.employee.index')}}';
function format ( d ) {
...
$(document).ready(function() {
    ...
    columns: [
            ...
            {data: 'role_type', name: 'role_type', orderable: false},
        ],
    order: [[0, 'desc']]
    });

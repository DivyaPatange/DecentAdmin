...
@section('page_title', 'Add Library Fine Collection')
@section('breadcrumb', 'Add Library Fine Collection')
@section('customcss')
    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5>Add Library Fine Collection</h5>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group form-default">
                                ...
                                <input type="date" name="collect_date" id="collect_date" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group form-default">
                                <label>Fine Amount <span  style="color:red" id="amt_err"> </span></label>
                                <input type="number" name="fine_amt" id="fine_amt" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
$('body').on('click', '#getList', function () {
    ...
    { 
        ...
        $.ajax({
            type:"POST",
            url:"{{ route('admin.library-fine.store') }}",
            data:datastring,
            cache:false,        

...
@section('title', 'Issued Book Return List')
@section('page_title', 'Issued Book Return List')
@section('breadcrumb', 'Issued Book Return List')
@section('customcss')
...
<div id="DivIdToPrint" class="hidden">
    <div class="row">
        <div class="col-md-12">
            <h2 style="text-align:center">Issued Book Return List</h2>
            ...
            <table  width="100%" style="text-align:center;border: 1px solid black; border-collapse: collapse;">
                <thead>
                    <tr>
                        ...
                        <th style="border: 1px solid black; border-collapse: collapse;">Issue Date</th>
                        <th style="border: 1px solid black; border-collapse: collapse;">Return Date</th>
...
$('#getList').click(function(){
    ...
    if(date_to == '')
    {
        ...
        $.ajax({
            type:"GET",
            url:"{{ url('admin/get-return-book-list') }}",

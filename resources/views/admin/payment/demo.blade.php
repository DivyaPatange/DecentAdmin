...
<body>
		...
		<div class="container " style="border: 2px solid #000;">
			<div class="row">
				...
				<div class="col-11 ">
                    ...
                    <?php 
                        $payment = DB::table('pays')->where('id', 1)->first();
                        $admission = DB::table('junior_admissions')->where('id', $payment->admission_id)->first();
                    ?>
					<div class="row py-4">
						<div class="col-6">
					...
					<div class="row">
						<div class="col-12 desc">
                            ...
                            <b>{{ $admission->student_name }}</b>
								...
								<b>{{ $Rupees }} Only</b>
								only towards. @if(!empty($feeHead)){{ $feeHead->fee_head }}@endif Through Cash <input type="radio" class="" name="pay_by" value="Cash">/ NEFT <input type="radio" class="" name="pay_by" value="NEFT">/ Cheque <input type="radio" class="" name="pay_by" value="Cheque">/ D.D. No <input type="radio" class="" name="pay_by" value="DD No">
					<span class="hidden showDiv"><input type="text" name="pay_no"  style="width: 20%;"></span> Dtd. <span id="hideDiv">{{ $payment->payment_date }} </span>
					<span class="showDiv hidden"><input type="date" name="" style=""></span>.
							</p>
						</div>
					</div>
	...
	<div class="row">
		<div class="col-md-2 m-auto">
            ...
            <button type='button' id='btn' onclick='printDiv();' class="mt-3 btn-success">Save</button>
		</div>
</div>

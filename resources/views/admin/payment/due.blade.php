                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-default">
                            ...
                            <input type="text" class="form-control" readonly placeholder="will generate after submitting form">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group form-default">
                            <label>Due Date</label>
                            <input type="date" class="form-control" readonly id="due_date" value="{{ $pay->due_date }}">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-block">
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group form-default">
                            <label>Payment Date <span  style="color:red" id="allot_class_err"> </span></label>
                            <input type="date" class="form-control" id="payment_date" style="background-color:#e9ecef" value="{{ date('Y-m-d') }}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group form-default">
                    ...
                    <div class="col-md-3">
                        <div class="form-group form-default">
                            ...
                            <input type="text" class="form-control" id="pay_ref_no" name="pay_ref_no">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group form-default">
                            <br>
                            <input type="hidden" name="fee_id" value="{{ $pay->fee_id }}">
                            <input type="hidden" name="fee_id" value="{{ $pay->fee_id }}">
                            <input type="hidden" name="fee_id" value="{{ $pay->fee_id }}">
                            <input type="hidden" name="fee_id" value="{{ $pay->fee_id }}">

...
<div class="row">
    <div class="col-md-12">
        ...
        <form method="POST" action="{{ route('admin.primary-school.store') }}" id="primary-form">
        @csrf
        <div class="card">
                ...
                <div class="row">
                    <div class="col-sm-6 col-xl-4">
                        <div class="form-group form-default">
                            <input type="text" name="school_id" class="form-control" id="school_id">
                            <span class="form-bar"></span>
                            <label class="float-label">School ID</label>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <h6 id="school_student_name"></h6>
                    </div>
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input type="text" name="gr_no" class="form-control" id="gr_no">
                            <span class="form-bar"></span>
                    ...
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input id="dropper-default" class="form-control" name="adm_date" type="text" placeholder="Select date" />
                            <span class="form-bar"></span>
                    ...
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input type="text" name="full_name_pupil" class="form-control" id="full_name_pupil">
                            <span class="form-bar"></span>
                    ...
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input type="text" name="race_caste" class="form-control" id="race_caste">
                            <span class="form-bar"></span>
                    ...
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input type="text" class="form-control autonumber" data-a-sign="Rs. " name="monthly_income" id="monthly_income">
                            <span class="form-bar"></span>
                    ...
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input id="dropper-animation" class="form-control" name="dob" type="text" placeholder="Select Date" />
                            <span class="form-bar"></span>
                    ...
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input type="text" name="last_school_attended" class="form-control" id="last_school_attended">
                            <span class="form-bar"></span>
                        ...
                        <div class="form-group form-default">
                            ...
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="rte" value="Yes" checked>Yes
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" name="rte" value="No">No
                                </label>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-block">
                <div class="row">
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input type="text" name="father_name1" class="form-control" id="father_name1">
                            <span class="form-bar"></span>
                    ...
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input type="text" name="f_occupation" class="form-control" id="f_occupation">
                            <span class="form-bar"></span>
                    ...
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input id="f_education" class="form-control" type="text" name="f_education"/>
                            <span class="form-bar"></span>
                    ...
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input type="text" name="f_phone_no" class="form-control" id="f_phone_no">
                            <span class="form-bar"></span>
                    ...
                    <div class="col-sm-8 col-xl-8">
                        <div class="form-group form-default">
                            <input type="text" name="f_address" class="form-control" id="f_address">
                            <span class="form-bar"></span>
        ...
        <div class="card">
            ...
            <div class="card-block">
                <div class="row">
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input type="text" name="mother_name1" class="form-control" id="mother_name1">
                            <span class="form-bar"></span>
                    ...
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input type="text" name="m_occupation" class="form-control" id="m_occupation">
                            <span class="form-bar"></span>
                    ...
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input id="m_education" class="form-control" type="text" name="m_education"/>
                            <span class="form-bar"></span>
                            <label class="float-label">Education<span  style="color:red" id="from_err"> </span></label>
                        </div>
                    </div>
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input type="text" name="m_phone_no" class="form-control" id="m_phone_no">
                            <span class="form-bar"></span>
                            <label class="float-label">Phone No.<span  style="color:red" id="from_err"> </span></label>
                        </div>
                    </div>
                    <div class="col-sm-8 col-xl-8">
                        <div class="form-group form-default">
                            <input type="text" name="m_address" class="form-control" id="m_address">
                            <span class="form-bar"></span>
                            <label class="float-label">Address<span  style="color:red" id="from_err"> </span></label>
                        </div>
                    </div>
        ...
        <div class="card">
            ...
            <div class="card-block">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input type="text" name="g_occupation" class="form-control" id="g_occupation">
                            <span class="form-bar"></span>
                    ...
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input id="g_education" class="form-control" type="text" name="g_education"/>
                            <span class="form-bar"></span>
                            <label class="float-label">Education<span  style="color:red" id="from_err"> </span></label>
                        </div>
                    </div>
                    <div class="col-sm-4 col-xl-4">
                        <div class="form-group form-default">
                            <input type="text" name="g_phone_no" class="form-control" id="g_phone_no">
                            <span class="form-bar"></span>
                            <label class="float-label">Phone No.<span  style="color:red" id="from_err"> </span></label>
                        </div>
                    </div>

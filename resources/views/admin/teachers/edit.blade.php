                    ...
                    <div class="col-sm-4 col-xs-4">
                        <div class="form-group form-default">
                            <select name="designation" class="form-control" id="designation">
                                ...
                                <option value="Lecturer" @if($teacher->designation == "Lecturer") Selected @endif>Lecturer</option>
                                <option value="Accountant" @if($teacher->designation == "Accountant") Selected @endif>Accountant</option>
                                <option value="Cashier" @if($teacher->designation == "Cashier") Selected @endif>Cashier</option>
                                <option value="Peon" @if($teacher->designation == "Peon") Selected @endif>Peon</option>

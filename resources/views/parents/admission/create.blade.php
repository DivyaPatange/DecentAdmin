...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" id="checkboxradio">
        ...
        <div class="card">
            <h5 class="card-header">Choose Admission Form</h5>
            <div class="card-body border-top">
                <label class="custom-control custom-radio custom-control-inline">
                    <input type="radio" name="radio-inline" class="custom-control-input" value="Primary School Admission"><span class="custom-control-label">Primary School Admission</span>
                </label>
                <label class="custom-control custom-radio custom-control-inline">
                    <input type="radio" name="radio-inline" class="custom-control-input" value="Junior College Admission"><span class="custom-control-label">Junior College Admission</span>
                </label>
            </div>
            <div id="priAdmission" class="hidden">
                <form method="POST" action="{{ url('/parent/primary-admission/store') }}" id="priSubmit">
                @csrf
                <div class="card-body">
                    <h5 class="card-header">Primary School Admission Form</h5>
                    <div class="row">
                        <div class="col-md-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button type="button" id="priButton" class="btn btn-primary">Submit</button>
                        </div>
                    </div> 
                </div>                     
                </form>
            ...
            <div id="jrAdmission" class="hidden">
                <div class="card-body">
                    <h5 class="card-header">Junior College Admission Form</h5>
                    <form method="post" enctype="multipart/form-data" id="jrSubmit" action="{{ url('/parent/junior-admission/store') }}">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button type="button" id="jrButton" class="btn btn-primary">Submit</button>
                        </div>
                    </div>
                    </form>
                </div>
...
$('body').on('click', 'input[name="radio-inline"]', function() {
  var form = $(this).val();

    ...
    <div class="row">
        ...
        <div class="card mt-4">
            <div class="card-header text-center">
                <a href="../index.html">
                    <h2 class="text-primary">Decent - Parent Login</h2>
            ...
            <div class="card-body">
                ...
                @csrf
                    <div class="form-group">
                        <input class="form-control form-control-lg" id="username" name="username" type="text" placeholder="Username" value="{{ old('username') }}">
                        @error('username')
            ...
            <div class="card-footer bg-white p-0  ">
                <div class="card-footer-item card-footer-item-bordered text-center">
                    <a href="{{ route('parent.register') }}" class="footer-link">Create An Account</a>
                </div>
